...
public class AppRequestLoginOption extends JSONWrapper{
	public static final int ID = 10;
	public static final String NAME = "AppRequestLoginOption";
	...
	public void copy( AppRequestLoginOption d ){
	...
	public static AppRequestLoginOption decoding(JSONObject obj) {
		AppRequestLoginOption wrapper = new AppRequestLoginOption();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppRequestLoginOption.NAME);
