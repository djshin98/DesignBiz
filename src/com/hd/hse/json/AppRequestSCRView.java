...
public class AppRequestSCRView extends JSONWrapper{
	public static final int ID = 67;
	public static final String NAME = "AppRequestSCRView";
	...
	public void copy( AppRequestSCRView d ){
	...
	public static AppRequestSCRView decoding(JSONObject obj) {
		AppRequestSCRView wrapper = new AppRequestSCRView();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppRequestSCRView.NAME);
