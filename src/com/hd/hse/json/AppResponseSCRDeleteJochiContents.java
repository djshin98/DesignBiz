...
public class AppResponseSCRDeleteJochiContents extends JSONWrapper{
	public static final int ID = 91;
	public static final String NAME = "AppResponseSCRDeleteJochiContents";
	...
	public void copy( AppResponseSCRDeleteJochiContents d ){
	...
	public static AppResponseSCRDeleteJochiContents decoding(JSONObject obj) {
		AppResponseSCRDeleteJochiContents wrapper = new AppResponseSCRDeleteJochiContents();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppResponseSCRDeleteJochiContents.NAME);
