...
public class AppRequestSCRIssueDeptList extends JSONWrapper{
	public static final int ID = 62;
	public static final String NAME = "AppRequestSCRIssueDeptList";
	...
	public void copy( AppRequestSCRIssueDeptList d ){
	...
	public static AppRequestSCRIssueDeptList decoding(JSONObject obj) {
		AppRequestSCRIssueDeptList wrapper = new AppRequestSCRIssueDeptList();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppRequestSCRIssueDeptList.NAME);
