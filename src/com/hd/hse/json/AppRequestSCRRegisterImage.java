...
public class AppRequestSCRRegisterImage extends JSONWrapper{
	public static final int ID = 77;
	public static final String NAME = "AppRequestSCRRegisterImage";
	...
	public void copy( AppRequestSCRRegisterImage d ){
	...
	public static AppRequestSCRRegisterImage decoding(JSONObject obj) {
		AppRequestSCRRegisterImage wrapper = new AppRequestSCRRegisterImage();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppRequestSCRRegisterImage.NAME);
