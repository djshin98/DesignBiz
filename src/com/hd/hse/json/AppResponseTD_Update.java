...
public class AppResponseTD_Update extends JSONWrapper{
	public static final int ID = 96;
	public static final String NAME = "AppResponseTD_Update";
	...
	public void copy( AppResponseTD_Update d ){
	...
	public static AppResponseTD_Update decoding(JSONObject obj) {
		AppResponseTD_Update wrapper = new AppResponseTD_Update();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppResponseTD_Update.NAME);
