...
public class AppResponseVersionCheck extends JSONWrapper{
	public static final int ID = 106;
	public static final String NAME = "AppResponseVersionCheck";
	...
	public String		gubun;	//현장 코드값
	public String		version;	//버젼
	public String		gps;	//GPS
	public String		language;	//모바일 사용자가 선택한 언어(한국어="ko",영어="en")

	public void copy( AppResponseVersionCheck d ){
	...
	public JSONObject encoding(){
		...
		try {
			...
			else{ obj.put("version",""); }
			if( gps != null ){ obj.put("gps",gps); }
			else{ obj.put("gps",""); }
	...
	public static AppResponseVersionCheck decoding(JSONObject obj) {
		AppResponseVersionCheck wrapper = new AppResponseVersionCheck();
		try {
			...
			if( obj.has("version") ){ wrapper.version = obj.getString("version"); }
			if( obj.has("gps") ){ wrapper.gps = obj.getString("gps"); }
	...
	public void print(String prefix){
		...
		if( version != null ){
			...
			System.out.println(prefix+"version : null" );
		}
		if( gps != null ){
			System.out.println(prefix+"gps : " + gps);
		}else{
			System.out.println(prefix+"gps : null" );
		}
		if( language != null ){
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppResponseVersionCheck.NAME);
