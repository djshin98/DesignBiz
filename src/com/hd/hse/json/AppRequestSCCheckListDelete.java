...
public class AppRequestSCCheckListDelete extends JSONWrapper{
	public static final int ID = 51;
	public static final String NAME = "AppRequestSCCheckListDelete";
	...
	public void copy( AppRequestSCCheckListDelete d ){
	...
	public static AppRequestSCCheckListDelete decoding(JSONObject obj) {
		AppRequestSCCheckListDelete wrapper = new AppRequestSCCheckListDelete();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppRequestSCCheckListDelete.NAME);
