...
public class AppResponseSCRRegister extends JSONWrapper{
	public static final int ID = 70;
	public static final String NAME = "AppResponseSCRRegister";
	...
	public void copy( AppResponseSCRRegister d ){
	...
	public static AppResponseSCRRegister decoding(JSONObject obj) {
		AppResponseSCRRegister wrapper = new AppResponseSCRRegister();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppResponseSCRRegister.NAME);
