...
public class AppResponseSCRDeleteJochi extends JSONWrapper{
	public static final int ID = 89;
	public static final String NAME = "AppResponseSCRDeleteJochi";
	...
	public void copy( AppResponseSCRDeleteJochi d ){
	...
	public static AppResponseSCRDeleteJochi decoding(JSONObject obj) {
		AppResponseSCRDeleteJochi wrapper = new AppResponseSCRDeleteJochi();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppResponseSCRDeleteJochi.NAME);
