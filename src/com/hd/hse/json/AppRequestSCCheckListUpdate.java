...
public class AppRequestSCCheckListUpdate extends JSONWrapper{
	public static final int ID = 47;
	public static final String NAME = "AppRequestSCCheckListUpdate";
	...
	public void copy( AppRequestSCCheckListUpdate d ){
	...
	public static AppRequestSCCheckListUpdate decoding(JSONObject obj) {
		AppRequestSCCheckListUpdate wrapper = new AppRequestSCCheckListUpdate();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppRequestSCCheckListUpdate.NAME);
