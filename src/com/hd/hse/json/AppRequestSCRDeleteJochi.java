...
public class AppRequestSCRDeleteJochi extends JSONWrapper{
	public static final int ID = 88;
	public static final String NAME = "AppRequestSCRDeleteJochi";
	...
	public void copy( AppRequestSCRDeleteJochi d ){
	...
	public static AppRequestSCRDeleteJochi decoding(JSONObject obj) {
		AppRequestSCRDeleteJochi wrapper = new AppRequestSCRDeleteJochi();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppRequestSCRDeleteJochi.NAME);
