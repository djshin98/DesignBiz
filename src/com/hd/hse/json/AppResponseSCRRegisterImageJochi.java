...
public class AppResponseSCRRegisterImageJochi extends JSONWrapper{
	public static final int ID = 84;
	public static final String NAME = "AppResponseSCRRegisterImageJochi";
	...
	public void copy( AppResponseSCRRegisterImageJochi d ){
	...
	public static AppResponseSCRRegisterImageJochi decoding(JSONObject obj) {
		AppResponseSCRRegisterImageJochi wrapper = new AppResponseSCRRegisterImageJochi();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppResponseSCRRegisterImageJochi.NAME);
