...
public class AppRequestSCRRegisterJochi extends JSONWrapper{
	public static final int ID = 81;
	public static final String NAME = "AppRequestSCRRegisterJochi";
	...
	public void copy( AppRequestSCRRegisterJochi d ){
	...
	public static AppRequestSCRRegisterJochi decoding(JSONObject obj) {
		AppRequestSCRRegisterJochi wrapper = new AppRequestSCRRegisterJochi();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppRequestSCRRegisterJochi.NAME);
