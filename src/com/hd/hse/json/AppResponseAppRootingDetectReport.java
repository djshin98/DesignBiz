...
public class AppResponseAppRootingDetectReport extends JSONWrapper{
	public static final int ID = 7;
	public static final String NAME = "AppResponseAppRootingDetectReport";
	public String		requestKey;	//요청 키
	public String		result;	//요청 처리 결과값
	public String		resultMessage;	//처리 오류 상세 메시지
	public String		language;	//모바일 사용자가 선택한 언어(한국어="ko",영어="en")

	public void copy( AppResponseAppRootingDetectReport d ){
	...
	public static AppResponseAppRootingDetectReport decoding(JSONObject obj) {
		AppResponseAppRootingDetectReport wrapper = new AppResponseAppRootingDetectReport();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppResponseAppRootingDetectReport.NAME);
