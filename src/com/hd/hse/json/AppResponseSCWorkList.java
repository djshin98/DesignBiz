...
public class AppResponseSCWorkList extends JSONWrapper{
	public static final int ID = 41;
	public static final String NAME = "AppResponseSCWorkList";
	...
	public ArrayList<AppWorkSafetyCheck>		workSCList;	//작업활동 목록
	public String		language;	//모바일 사용자가 선택한 언어(한국어="ko",영어="en")

	public void copy( AppResponseSCWorkList d ){
	...
	public static AppResponseSCWorkList decoding(JSONObject obj) {
		AppResponseSCWorkList wrapper = new AppResponseSCWorkList();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppResponseSCWorkList.NAME);
