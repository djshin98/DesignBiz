...
public class AppResponseSCRSendSMS extends JSONWrapper{
	public static final int ID = 74;
	public static final String NAME = "AppResponseSCRSendSMS";
	...
	public void copy( AppResponseSCRSendSMS d ){
	...
	public static AppResponseSCRSendSMS decoding(JSONObject obj) {
		AppResponseSCRSendSMS wrapper = new AppResponseSCRSendSMS();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppResponseSCRSendSMS.NAME);
