...
public class AppRequestEmployeeManageDetail extends JSONWrapper{
	public static final int ID = 18;
	public static final String NAME = "AppRequestEmployeeManageDetail";
	public String		requestKey;	//요청 키
	public String		sitecode;	//현장 코드값
	public String		userid;	//사용자 아이디
	public String		supcode;	//협력사 코드
	public Timestamp		date;	//메시지 발송 시간 정보
	public Timestamp		workdate;	//출역 요청일(시간) 정보
	public String		language;	//모바일 사용자가 선택한 언어(한국어="ko",영어="en")

	public void copy( AppRequestEmployeeManageDetail d ){
	...
	public static AppRequestEmployeeManageDetail decoding(JSONObject obj) {
		AppRequestEmployeeManageDetail wrapper = new AppRequestEmployeeManageDetail();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppRequestEmployeeManageDetail.NAME);
