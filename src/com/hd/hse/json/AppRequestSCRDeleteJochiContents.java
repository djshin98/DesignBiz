...
public class AppRequestSCRDeleteJochiContents extends JSONWrapper{
	public static final int ID = 90;
	public static final String NAME = "AppRequestSCRDeleteJochiContents";
	...
	public void copy( AppRequestSCRDeleteJochiContents d ){
	...
	public static AppRequestSCRDeleteJochiContents decoding(JSONObject obj) {
		AppRequestSCRDeleteJochiContents wrapper = new AppRequestSCRDeleteJochiContents();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppRequestSCRDeleteJochiContents.NAME);
