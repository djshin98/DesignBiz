...
public class AppRequestSCCheckWriteList extends JSONWrapper{
	public static final int ID = 49;
	public static final String NAME = "AppRequestSCCheckWriteList";
	...
	public void copy( AppRequestSCCheckWriteList d ){
	...
	public static AppRequestSCCheckWriteList decoding(JSONObject obj) {
		AppRequestSCCheckWriteList wrapper = new AppRequestSCCheckWriteList();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppRequestSCCheckWriteList.NAME);
