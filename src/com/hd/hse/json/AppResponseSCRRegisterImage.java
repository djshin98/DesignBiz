...
public class AppResponseSCRRegisterImage extends JSONWrapper{
	public static final int ID = 78;
	public static final String NAME = "AppResponseSCRRegisterImage";
	...
	public void copy( AppResponseSCRRegisterImage d ){
	...
	public static AppResponseSCRRegisterImage decoding(JSONObject obj) {
		AppResponseSCRRegisterImage wrapper = new AppResponseSCRRegisterImage();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppResponseSCRRegisterImage.NAME);
