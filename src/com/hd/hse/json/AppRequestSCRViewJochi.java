...
public class AppRequestSCRViewJochi extends JSONWrapper{
	public static final int ID = 86;
	public static final String NAME = "AppRequestSCRViewJochi";
	...
	public void copy( AppRequestSCRViewJochi d ){
	...
	public static AppRequestSCRViewJochi decoding(JSONObject obj) {
		AppRequestSCRViewJochi wrapper = new AppRequestSCRViewJochi();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppRequestSCRViewJochi.NAME);
