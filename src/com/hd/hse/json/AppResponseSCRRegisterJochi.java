...
public class AppResponseSCRRegisterJochi extends JSONWrapper{
	public static final int ID = 82;
	public static final String NAME = "AppResponseSCRRegisterJochi";
	...
	public void copy( AppResponseSCRRegisterJochi d ){
	...
	public static AppResponseSCRRegisterJochi decoding(JSONObject obj) {
		AppResponseSCRRegisterJochi wrapper = new AppResponseSCRRegisterJochi();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppResponseSCRRegisterJochi.NAME);
