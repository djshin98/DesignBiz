...
public class AppRequestLoginDevice extends JSONWrapper{
	public static final int ID = 9;
	public static final String NAME = "AppRequestLoginDevice";
	public String		requestKey;	//요청 키
	public String		userid;	//사용자 아이디
	public String		password;	//사용자 암호 *******
	public String		deviceKey;	//디바이스 키
	public String		authKey;	//인증 키
	public String		language;	//모바일 사용자가 선택한 언어(한국어="ko",영어="en")

	public void copy( AppRequestLoginDevice d ){
	...
	public JSONObject encoding(){
		...
		try {
			...
			if( authKey != null ){ obj.put("authKey",authKey); }
			else{ obj.put("authKey",""); }
	...
	public static AppRequestLoginDevice decoding(JSONObject obj) {
		AppRequestLoginDevice wrapper = new AppRequestLoginDevice();
		try {
			...
			if( obj.has("authKey") ){ wrapper.authKey = obj.getString("authKey"); }
	...
	public void print(String prefix){
		...
		if( authKey != null ){
			System.out.println(prefix+"authKey : " + authKey);
		}else{
			System.out.println(prefix+"authKey : null" );
		}
		if( language != null ){
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppRequestLoginDevice.NAME);
