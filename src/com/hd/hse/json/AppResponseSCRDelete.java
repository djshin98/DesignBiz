...
public class AppResponseSCRDelete extends JSONWrapper{
	public static final int ID = 76;
	public static final String NAME = "AppResponseSCRDelete";
	...
	public void copy( AppResponseSCRDelete d ){
	...
	public static AppResponseSCRDelete decoding(JSONObject obj) {
		AppResponseSCRDelete wrapper = new AppResponseSCRDelete();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppResponseSCRDelete.NAME);
