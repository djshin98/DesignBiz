...
public class AppRequestAllowedMenu extends JSONWrapper{
	public static final int ID = 1;
	public static final String NAME = "AppRequestAllowedMenu";
	public String		requestKey;	//요청 키
	public String		sitecode;	//현장 코드값
	public String		userid;	//사용자 아이디
	public String		language;	//모바일 사용자가 선택한 언어(한국어="ko",영어="en")

	public void copy( AppRequestAllowedMenu d ){
	...
	public static AppRequestAllowedMenu decoding(JSONObject obj) {
		AppRequestAllowedMenu wrapper = new AppRequestAllowedMenu();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppRequestAllowedMenu.NAME);
