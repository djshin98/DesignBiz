...
public class AppRequestAppRootingDetectReport extends JSONWrapper{
	public static final int ID = 6;
	public static final String NAME = "AppRequestAppRootingDetectReport";
	...
	public String		report;	//탐지 보고서
	public String		language;	//모바일 사용자가 선택한 언어(한국어="ko",영어="en")

	public void copy( AppRequestAppRootingDetectReport d ){
	...
	public JSONObject encoding(){
		...
		try {
			...
			if( report != null ){ obj.put("report",report); }
			else{ obj.put("report",""); }
	...
	public static AppRequestAppRootingDetectReport decoding(JSONObject obj) {
		AppRequestAppRootingDetectReport wrapper = new AppRequestAppRootingDetectReport();
		try {
			...
			if( obj.has("report") ){ wrapper.report = obj.getString("report"); }
	...
	public void print(String prefix){
		...
		if( report != null ){
			System.out.println(prefix+"report : " + report);
		}else{
			System.out.println(prefix+"report : null" );
		}
		if( language != null ){
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppRequestAppRootingDetectReport.NAME);
