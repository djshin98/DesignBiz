...
public class AppResponseTD_Insert extends JSONWrapper{
	public static final int ID = 94;
	public static final String NAME = "AppResponseTD_Insert";
	...
	public void copy( AppResponseTD_Insert d ){
	...
	public static AppResponseTD_Insert decoding(JSONObject obj) {
		AppResponseTD_Insert wrapper = new AppResponseTD_Insert();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppResponseTD_Insert.NAME);
