...
public class AppRequestTD_Update extends JSONWrapper{
	public static final int ID = 95;
	public static final String NAME = "AppRequestTD_Update";
	...
	public void copy( AppRequestTD_Update d ){
	...
	public static AppRequestTD_Update decoding(JSONObject obj) {
		AppRequestTD_Update wrapper = new AppRequestTD_Update();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppRequestTD_Update.NAME);
