...
public class AppResponseSCCheckListUpdate extends JSONWrapper{
	public static final int ID = 48;
	public static final String NAME = "AppResponseSCCheckListUpdate";
	...
	public void copy( AppResponseSCCheckListUpdate d ){
	...
	public static AppResponseSCCheckListUpdate decoding(JSONObject obj) {
		AppResponseSCCheckListUpdate wrapper = new AppResponseSCCheckListUpdate();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppResponseSCCheckListUpdate.NAME);
