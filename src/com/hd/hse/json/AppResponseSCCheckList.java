...
public class AppResponseSCCheckList extends JSONWrapper{
	public static final int ID = 44;
	public static final String NAME = "AppResponseSCCheckList";
	...
	public ArrayList<AppWorkSafetyCheck>		workSCList;	//작업 체크 목록
	public String		language;	//모바일 사용자가 선택한 언어(한국어="ko",영어="en")

	public void copy( AppResponseSCCheckList d ){
	...
	public static AppResponseSCCheckList decoding(JSONObject obj) {
		AppResponseSCCheckList wrapper = new AppResponseSCCheckList();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppResponseSCCheckList.NAME);
