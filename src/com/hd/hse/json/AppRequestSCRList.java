...
public class AppRequestSCRList extends JSONWrapper{
	public static final int ID = 58;
	public static final String NAME = "AppRequestSCRList";
	...
	public void copy( AppRequestSCRList d ){
	...
	public static AppRequestSCRList decoding(JSONObject obj) {
		AppRequestSCRList wrapper = new AppRequestSCRList();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppRequestSCRList.NAME);
