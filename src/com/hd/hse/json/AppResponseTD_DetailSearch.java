...
public class AppResponseTD_DetailSearch extends JSONWrapper{
	public static final int ID = 102;
	public static final String NAME = "AppResponseTD_DetailSearch";
	...
	public void copy( AppResponseTD_DetailSearch d ){
	...
	public static AppResponseTD_DetailSearch decoding(JSONObject obj) {
		AppResponseTD_DetailSearch wrapper = new AppResponseTD_DetailSearch();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppResponseTD_DetailSearch.NAME);
