...
public class AppResponseSCGongjongList extends JSONWrapper{
	public static final int ID = 39;
	public static final String NAME = "AppResponseSCGongjongList";
	...
	public ArrayList<AppWorkSafetyCheck>		workSCList;	//공종 목록
	public String		language;	//모바일 사용자가 선택한 언어(한국어="ko",영어="en")

	public void copy( AppResponseSCGongjongList d ){
	...
	public static AppResponseSCGongjongList decoding(JSONObject obj) {
		AppResponseSCGongjongList wrapper = new AppResponseSCGongjongList();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppResponseSCGongjongList.NAME);
