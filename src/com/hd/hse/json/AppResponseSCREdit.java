...
public class AppResponseSCREdit extends JSONWrapper{
	public static final int ID = 72;
	public static final String NAME = "AppResponseSCREdit";
	...
	public void copy( AppResponseSCREdit d ){
	...
	public static AppResponseSCREdit decoding(JSONObject obj) {
		AppResponseSCREdit wrapper = new AppResponseSCREdit();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppResponseSCREdit.NAME);
