...
public class AppRequestConstructMachineList extends JSONWrapper{
	public static final int ID = 21;
	public static final String NAME = "AppRequestConstructMachineList";
	...
	public void copy( AppRequestConstructMachineList d ){
	...
	public static AppRequestConstructMachineList decoding(JSONObject obj) {
		AppRequestConstructMachineList wrapper = new AppRequestConstructMachineList();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppRequestConstructMachineList.NAME);
