...
public class AppRequestSCREmployeeList extends JSONWrapper{
	public static final int ID = 64;
	public static final String NAME = "AppRequestSCREmployeeList";
	...
	public void copy( AppRequestSCREmployeeList d ){
	...
	public static AppRequestSCREmployeeList decoding(JSONObject obj) {
		AppRequestSCREmployeeList wrapper = new AppRequestSCREmployeeList();
		try {
	...
	public JSONObject toMessage(){
		JSONObject obj = new JSONObject();
		try {
			obj.put("requestObjectName", AppRequestSCREmployeeList.NAME);
